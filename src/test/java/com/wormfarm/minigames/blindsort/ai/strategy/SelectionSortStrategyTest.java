...
class SelectionSortStrategyTest {
    ...
    @InjectMocks
    private SelectionSortStrategy selectionSortStrategy;
    ...
    void shouldReturnFirstUnsortedPairWhenArrayIsUnsortedFullVisibility() {
        ...
        Optional<int[]> nextMove = selectionSortStrategy.getNextMove(numbers, 5, 0.0);
    ...
    void shouldReturnFirstUnsortedPairWhenArrayIsUnsortedPartialVisibility() {
        ...
        Optional<int[]> nextMove = selectionSortStrategy.getNextMove(numbers, 4, 0.0);
        assertTrue(nextMove.isPresent());
        assertArrayEquals(new int[]{0, 1}, nextMove.get());
    }
    ...
    void compareNumbersShouldCompareFullNumbersWhenVisibleDigitsIs5Num1GreaterThanNum2() {
        int[] num1 = {1, 2, 3, 4, 7};
        int[] num2 = {1, 2, 3, 4, 6};
        assertTrue(selectionSortStrategy.compareNumbers(num1, num2, 5) > 0);
    }
    ...
    void compareNumbersShouldCompareFullNumbersWhenVisibleDigitsIs5Num1EqualsNum2() {
        int[] num1 = {1, 2, 3, 4, 5};
        int[] num2 = {1, 2, 3, 4, 5};
        assertEquals(0, selectionSortStrategy.compareNumbers(num1, num2, 5));
    }
    ...
    void compareNumbersShouldCompareByLastVisibleDigitWhenVisibleDigitsIsLessThan5Num1LessThanNum2() {
        int[] num1 = {1, 2, 3, 4, 5};
        int[] num2 = {1, 2, 4, 0, 0};
        assertTrue(selectionSortStrategy.compareNumbers(num1, num2, 3) < 0);
    }
    ...
    void compareNumbersShouldCompareByLastVisibleDigitWhenVisibleDigitsIsLessThan5Num1EqualsNum2() {
        int[] num1 = {1, 2, 3, 4, 5};
        int[] num2 = {1, 0, 3, 9, 9};
        assertEquals(0, selectionSortStrategy.compareNumbers(num1, num2, 3));
    }
    ...
    void convertDigitsToLongShouldConvertSingleDigitArrayToLong() {
        assertEquals(5L, selectionSortStrategy.convertDigitsToLong(new int[]{5}));
    }

    @Test
    void convertDigitsToLongShouldConvertMultipleDigitArrayToLong() {
        assertEquals(12345L, selectionSortStrategy.convertDigitsToLong(new int[]{1, 2, 3, 4, 5}));
    }

    @Test
    void convertDigitsToLongShouldConvertArrayWithLeadingZerosToCorrectLongValue() {
        assertEquals(123L, selectionSortStrategy.convertDigitsToLong(new int[]{0, 0, 1, 2, 3}));
    }

    @Test
    void convertDigitsToLongShouldConvertArrayOfAllZerosToZeroLongValue() {
        assertEquals(0L, selectionSortStrategy.convertDigitsToLong(new int[]{0, 0, 0, 0, 0}));
    }

    @Test
    void convertDigitsToLongShouldConvertEmptyArrayToZeroLongValue() {
        assertEquals(0L, selectionSortStrategy.convertDigitsToLong(new int[]{}));
    }

    @Test
    void getNameMethodShouldReturnSelection() {
        assertEquals("selection", selectionSortStrategy.getName());
    }
    ...
    void shouldNotReturnRandomIndicesWhenErrorChanceIsNotMet() {
        ...
        Optional<int[]> nextMove = selectionSortStrategy.getNextMove(sortedNumbersForErrorChance, 5, 0.1);
        assertFalse(nextMove.isPresent());
    }
}