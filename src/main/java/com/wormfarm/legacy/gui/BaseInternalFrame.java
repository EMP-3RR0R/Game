...
public abstract class BaseInternalFrame extends JInternalFrame {
    ...
    public BaseInternalFrame(String titleKey, boolean resizable, boolean closable,
        ...
        this.addInternalFrameListener(new InternalFrameAdapter() {
            ...
            public void internalFrameClosing(InternalFrameEvent e) {
                System.out.println("Internal frame closing event triggered for: " + getTitle());
                confirmClose();
            }
        });

        System.out.println("BaseInternalFrame constructed for: " + titleKey);
    }

    protected void confirmClose() {
        System.out.println("confirmClose called");
    ...
    public void updateLocale() {
        messages = ResourceBundle.getBundle("com.robot.gui.messages", currentLocale);
