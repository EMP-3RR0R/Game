package com.wormfarm.legacy.core;

import com.wormfarm.legacy.minigame.FifteenPuzzleFrame;
...
public class GameVisualizer extends JPanel {
    ...
    private void drawRobot(Graphics2D g, int x, int y, double direction) {
        AffineTransform oldTransform = g.getTransform(); // Сохраняем текущую трансформацию

        AffineTransform t = AffineTransform.getRotateInstance(direction, x, y);
        g.setTransform(t); // Поворачиваем систему координат
        ...
        g.setTransform(oldTransform); // Возвращаем обратно, чтобы не повлияло на другие объекты
    }
